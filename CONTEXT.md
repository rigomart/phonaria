...
returned is not such evidence. Jev (TypeSafe's decision model, through OpenRouter) picks
among the same candidates with the sentence in view, and the frequency rule decides whenever
that call is unavailable. The learner-facing line uses the
