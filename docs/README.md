...
- [`research/`](./research/) – Point-in-time records of investigations and measured decisions, such as the migration to Cloudflare Workers and the [spelling suggestion case review](./research/issue-247-spelling-suggestion-case-review.md) and its [two-edit follow-up](./research/issue-248-two-edit-spelling-suggestions.md), kept as evidence rather than as current guidance.
