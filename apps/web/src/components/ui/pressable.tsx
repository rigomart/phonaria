...
const pressableVariants = cva(
	"inline-flex items-center justify-center rounded-md text-sm transition-all outline-none cursor-pointer focus-visible:ring-ring/50 focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 select-none",
	{
		variants: {
			variant: {
