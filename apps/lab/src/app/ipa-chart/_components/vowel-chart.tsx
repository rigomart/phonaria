							...
							render={
								<button
									...
									className={cn(
										...
										"hover:z-10",
										{
											"border-transparent bg-primary text-primary-foreground rounded-full size-6 sm:size-9 hover:bg-primary/80":
												isRounded && !isRhotic,
											"border-primary bg-background text-foreground rounded-full size-6 sm:size-9 hover:bg-primary/10 hover:text-primary":
												!isRounded && !isRhotic,
											"border-dashed border-primary bg-primary/10 text-foreground rounded-full size-6 sm:size-9 hover:bg-primary/20 hover:border-primary":
												isRhotic,
										},
									)}
