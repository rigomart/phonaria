...
| `bun --cwd packages/lab-contract e2e:start-slice` | Credits, IPA charts, Practice (when the target enables it), metadata, 404, CSP, and accessibility checks for the Cloudflare Start slice |
