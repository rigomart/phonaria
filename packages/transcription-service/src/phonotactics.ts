...
/**
 * Valid English onsets (syllable-initial consonant clusters).
 * Based on English phonotactic constraints.
 */
...
/**
 * Check if a sequence of consonant tokens forms a valid English onset.
 */
